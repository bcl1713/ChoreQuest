...
- Store any new patterns or solutions in `dev/` project memory/documentation
- Update entity relationships discovered in `dev/PROJECT_KNOWLEDGE.md` (if exists)
- Add observations about system behavior in `dev/TROUBLESHOOTING.md` (if exists)
