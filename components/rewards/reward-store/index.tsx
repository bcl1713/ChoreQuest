...
import { CheckCircle, Star, Coins, Bell, Check, X } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-4">
        <div className="flex items-center justify-between">
          ...
          >
            <Star size={24} aria-hidden="true" className="text-yellow-600" />
            Reward Store
          </h2>
          <div className="flex items-center space-x-4">
            {hasPendingRedemptions && (
              <div className="flex items-center space-x-2 bg-orange-100 px-3 py-1 rounded-full">
                <Bell size={16} aria-hidden="true" className="text-orange-600" />
            ...
            <div className="flex items-center space-x-2">
              <Coins size={20} aria-hidden="true" className="text-yellow-600" />
              <span
      ...
      {hasPendingRedemptions && (
        <div className="border-2 border-orange-200 bg-orange-50 rounded-lg p-6">
          <h3 className="text-xl font-bold text-orange-800 mb-4 flex items-center gap-2">
            <Bell size={20} aria-hidden="true" className="text-orange-600" />
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <div className="flex items-center space-x-1">
                        <Coins size={14} aria-hidden="true" className="text-yellow-600" />
