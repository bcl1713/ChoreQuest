...
describe("RedemptionList - pending", () => {
  ...
  describe("Empty States", () => {
    it("should render nothing when no redemptions provided", () => {
      const { container } = render(<RedemptionList redemptions={[]} {...handlers} />);
    ...
    it("should not show approved section when no approved redemptions", () => {
      render(<RedemptionList redemptions={[createMockRedemption("1", "PENDING")]} {...handlers} />);
  ...
  describe("Pending Redemptions", () => {
    ...
    it("should display notes when present", () => {
      render(
        <RedemptionList
          redemptions={[createMockRedemption("1", "PENDING", { notes: "Please approve soon!" })]}
          {...handlers}
        />
      );
    ...
    it("should call onApprove when approve button clicked", () => {
      render(
        <RedemptionList redemptions={[createMockRedemption("redemption-1", "PENDING")]} {...handlers} />
      );
    ...
    it("should call onDeny when deny button clicked", () => {
      render(
        <RedemptionList redemptions={[createMockRedemption("redemption-2", "PENDING")]} {...handlers} />
      );
