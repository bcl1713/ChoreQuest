...
describe('RewardItem - rendering', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should show inactive badge when reward is inactive', () => {
      ...
      const { container } = render(<RewardItem reward={reward} onEdit={mockOnEdit} onDelete={mockOnDelete} onToggleActive={mockOnToggleActive} />);
