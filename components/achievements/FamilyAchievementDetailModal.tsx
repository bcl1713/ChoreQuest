...
import { getFamilyAchievementState } from "./FamilyAchievementBadge";
import { cn } from "@/lib/utils";
import type { FamilyAchievementDisplay } from "@/hooks/useFamilyAchievements";

interface FamilyAchievementDetailModalProps {
  achievement: FamilyAchievementDisplay | null;
  onClose: () => void;
}

export function FamilyAchievementDetailModal({
  achievement,
  onClose,
}: FamilyAchievementDetailModalProps) {
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        onClick={onClose}
        data-testid="family-achievement-detail-overlay"
      >
        <motion.div
          ...
          data-testid="family-achievement-detail-modal"
        >
          {/* Header */}
          <div className="flex items-start justify-between mb-4">
            ...
            <button
              type="button"
              onClick={onClose}
              aria-label="Close family achievement details"
              className="text-gray-400 hover:text-gray-200 transition-colors"
              data-testid="family-achievement-detail-close"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          {isUnlocked && achievement.unlocked_at && (
            <p
              ...
              data-testid="family-achievement-unlock-date"
            >
              Unlocked on{" "}
