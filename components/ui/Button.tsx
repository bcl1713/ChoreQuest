...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  gold: "bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white shadow-md focus-visible:ring-gold-400",
  "gold-solid":
  ...
  ghost: "text-gray-200 hover:bg-dark-800 focus-visible:ring-gray-500",
};
