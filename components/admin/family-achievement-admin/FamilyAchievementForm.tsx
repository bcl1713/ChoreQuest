...
import type {
  FamilyAchievementFormData,
  AdminCategoryOption,
} from "./useFamilyAchievementAdmin";

interface FamilyAchievementFormProps {
  mode: "create" | "edit";
  formData: FamilyAchievementFormData;
  categories: AdminCategoryOption[];
  actionLoading: boolean;
  onSubmit: () => void;
  onCancel: () => void;
  onChange: (
    field: keyof FamilyAchievementFormData,
    value: string | boolean,
  ) => void;
}

export function FamilyAchievementForm({
  mode,
  formData,
  categories,
  actionLoading,
  ...
  onCancel,
  onChange,
}: FamilyAchievementFormProps) {
  const title =
    mode === "create" ? "Create Family Achievement" : "Edit Family Achievement";
  const submitText =
    mode === "create" ? "Create Family Achievement" : "Save Changes";
  ...
  const isValid =
    formData.name.trim().length > 0 && formData.criteria_type.trim().length > 0;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div
        className="fantasy-card p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto"
        data-testid="family-achievement-form"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Family Quest Master"
              data-testid="family-achievement-name-input"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-dark-700 border border-gray-600 rounded-lg px-3 py-2 text-gray-100 focus:border-gold-500 focus:outline-none"
              placeholder="Family achievement description"
              rows={2}
              data-testid="family-achievement-description-input"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-dark-700 border border-gray-600 rounded-lg px-3 py-2 text-gray-100 focus:border-gold-500 focus:outline-none"
                data-testid="family-achievement-category-select"
              >
            ...
            <div>
              ...
              <input
                ...
                data-testid="family-achievement-icon-input"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              data-testid="family-achievement-criteria-type-input"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder='{"threshold": 50, "family_evaluation_mode": "sum"}'
              rows={3}
              data-testid="family-achievement-criteria-config-input"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              data-testid="family-achievement-hidden-toggle"
            />
            <label htmlFor="fa_is_hidden" className="text-sm text-gray-300">
              Hidden achievement
            </label>
          </div>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <div className="flex-1">
              <Button
                ...
                size="sm"
                fullWidth
                data-testid="family-achievement-submit-button"
              >
                {submitText}
              </Button>
            </div>
