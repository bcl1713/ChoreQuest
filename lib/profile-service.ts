...
export class ProfileService {
  ...
  static async changeCharacterName(
    ...
    // TODO: Record change in history table (not yet implemented)
   ...
   */
  static async canChangeClass(): Promise<boolean> {
    // TODO: Implement class change cooldown when last_class_change_at column exists
    // For now, allow class changes without cooldown check
    return true;
    // const { data, error } = await supabase
    //   .from("characters")
   ...
   */
  static async getClassChangeCooldownRemaining(): Promise<number> {
    // TODO: Implement class change cooldown when last_class_change_at column exists
   ...
   */
  static async getChangeHistory(): Promise<ChangeHistoryEntry[]> {
    // TODO: Implement character change history table (not yet implemented)
