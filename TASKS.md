...
- [ ] Fix Realtime 406 errors causing CHANNEL_ERROR status in quest-completion-rewards.spec.ts
- [ ] Fix page loading state issues preventing quest approval/completion buttons from appearing
